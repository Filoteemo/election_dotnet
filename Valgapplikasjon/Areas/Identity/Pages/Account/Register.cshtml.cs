        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Bekreft e-postadressen din",
                        $"Hei, <br> E-postadressen din bekrefter du ved &aring; <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>klikke her</a>. <br><br><br>Vennlig hilsen,<br>Valgapp Admin");
